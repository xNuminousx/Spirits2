...
public class LightBlast extends LightAbility implements AddonAbility {
    ...
    public LightBlast(Player player, ActivationType activationType) {
        super(player);
        ...
        if (activationType == ActivationType.SHIFT && hasAbility(player, LightBlast.class)) {
            ...
            if (lightBlast.getTarget() != null) {
                Entity targetedEntity = GeneralMethods.getTargetedEntity(player, lightBlast.getRange());

                if (targetedEntity == null || !targetedEntity.equals(lightBlast.getTarget()))
                    return;
    ...
    public String getDescription() {
        return StringUtils.formatDescription(AbilityType.OFFENSE, SpiritType.LIGHT, "Shoot a blast of light.");
    }

    @Override
    public String getInstructions() {
        return StringUtils.getSpiritColor(SpiritType.LIGHT) + "Left-click to shoot.";
    }
